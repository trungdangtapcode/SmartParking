"""
Disconnect detection middleware for streaming endpoints
"""
import logging
...
async def cancel_on_disconnect(request: Request):
    """
    Watch for client disconnect and cancel the task group when detected.
    
    Usage:
        async with cancel_on_disconnect(request):
            # Your streaming code here
            # Will raise CancelledError when client disconnects
    """
