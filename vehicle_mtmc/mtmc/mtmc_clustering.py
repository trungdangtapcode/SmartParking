...
def mtmc_clustering(tracks: List[List[Tracklet]],
    ...
    # log.info("Starting clustering of %s tracks, precomputing compatibility and similarity matrices ...", n) ### DEBUG
    ...
    # log.info(f"Precomputation finished, took {time.time() - log_start_time:.3f} s.") ### DEBUG
    ...
    # log.info(
    #     "mtmc clustering took %s seconds: %s final tracks.", log_total_time, len(mtracks)) ### DEBUG
