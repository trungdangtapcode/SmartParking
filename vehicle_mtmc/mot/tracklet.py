...
class Tracklet:
    ...
    def __init__(self, track_id):
        ...
        # license plate information (OCR result)
        self.plate = None
    ...
    def update(self, frame_num, bbox, conf, feature=None, static_attributes=None, dynamic_attributes=None, zone_id=None, plate=None):
        ...
        # Update plate if detected (keep first non-null plate)
        if plate is not None and self.plate is None:
            self.plate = plate
